...
class MoopisRepository(
    ...
    override fun getMovie(): LiveData<Resource<PagedList<MoviesEntity>>> {
        return object : NetworkBoundResource<PagedList<MoviesEntity>, MoviesResponse>(appExecutors) {
            ...
            override fun createCall(): LiveData<ApiResponse<MoviesResponse>> = remoteDataSource.getMovie()
